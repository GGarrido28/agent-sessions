...
- With a held lock, a turn abandoned without writing its completion reads `busy` until it has been quiet for two days. See above for why that is the right side to err on.
